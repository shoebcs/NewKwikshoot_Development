...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Kwikshoot User Login</b></a>
  </div>
  <!-- /.login-logo -->
...
<!--          <input type="password" class="form-control" placeholder="Password">-->
    ...
    <div class="row">
        <br>
        <div class="col-xs-4">
          <?php echo $this->Html->link('Sign up' , array('action'=>'userregistration'),array('escape'=>'utf-8','class'=>'text-center btn btn-info')); ?>
          </div>
        
        <!-- /.col -->
        <div class="col-xs-8">
          <?php echo $this->Html->link('Forgot password' , array('action'=>'forgotpassword'),array('escape'=>'utf-8','class'=>'text-center btn btn-info')); ?>
        </div>
