...
<td align="left">
<p><b>Hi Admin,</b></p><br>
<p>Here is a new User Registration by <?php echo $userInfo['first_name'] ;?><?php echo ' '; ?> <?php echo $userInfo['last_name'] ;?> , Details are Listed Below:</p>
</td>
</tr>
...
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">User Registration Date</td>
