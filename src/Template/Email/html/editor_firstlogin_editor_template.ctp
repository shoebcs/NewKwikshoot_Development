...
<td align="left">
<p><b>Hi Admin,</b></p><br>
<p>It is  noticed that the below Editor login in his/her account first time, please find the editor details</p>
</td>
</tr>
...
<tr><th colspan="2" style="font-size: 17px; font-weight: 600;">Editor Details</th></tr>
</thead>
<tbody>
<tr>
...
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Editor Email</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);color:#dd0c1f;"><?php echo $userInfo['email'];?></td>
</tr>


<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Editor Phone</td>
