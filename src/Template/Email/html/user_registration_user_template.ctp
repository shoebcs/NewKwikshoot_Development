...
<tr>
<td align="left">
    <p><b>Hi <?php echo $userInfo['first_name']; ?>,</b></p><br>
<p>You have been successfully Registered with Kwikshoot. Please find your login details.</p>
</td>
</tr>
...
<tr><th colspan="2" style="font-size: 17px; font-weight: 600;">User Registration Details</th></tr>
</thead>
<tbody>
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Your Name</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['first_name'] ;?><?php echo ' '; ?> <?php echo $userInfo['last_name'] ;?></td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Your  Email</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['email'];?></td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Your Password</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['password'];?></td>
</tr>
