...
<tr>
<td align="left">
<p><b>Hi <?php echo $userInfo['name']; ?>,</b></p><br>
<p>Your Job is Assign to One of our Editor.  Please Find the Details:</p>
</td>
</tr>
...
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Your Job ID</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['Job_ID'];?></td>
</tr>
<?php if($userInfo['Video_Description']!='') {?>
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Your Job Description</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['Video_Description'];?></td>
</tr>
<?php } ?>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Job Assign Date</td>
