...
<td align="left">
<p><b>Hi Admin,</b></p><br>
<p>Here is a new  Enquiry by <?php echo $userInfo['name'] ;?> , Details are Listed Below:</p>
</td>
</tr>
...
<tr><th colspan="2" style="font-size: 17px; font-weight: 600;">User Enquiry Details</th></tr>
</thead>
<tbody>
<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">User Name</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['name'] ;?><?php echo ' '; ?> </td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">User Email</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);color:#dd0c1f;"><?php echo $userInfo['email'];?></td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Phone</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['phone'];?></td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Company</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['company'];?></td>
</tr>


<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Title</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['title'];?></td>
</tr>

<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Message</td>
<td align="left" style="border: 1px solid rgb(238, 238, 238);"><?php echo $userInfo['description'];?></td>
</tr>


<tr>
<td align="left" style="border: 1px solid rgb(238, 238, 238);">Enquiry  Date</td>
